...
\code{a}. \sidenote{An assign statement in programming is not a
  ...
  sensitive} 
Sometimes you may want your program to prompt the user to
...
When you do, that number will be saved to the variable \texttt{a}.
...
third element (element 2 is the third character) and going through the
11th element.  You can add a stepsize, like we've done in the second
statement.  In this case, the three means that it will extract every
third character starting at the third and ending at the 11th.
...
#Try printing each of these to what is in each slice
aList[1:]
aList[1:3]
aList[:3]
aList[1:4:2]
