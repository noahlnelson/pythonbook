...
library called \code{numpy} .  The main object used in this library is called an
\code{array}, which is very similar to a list except that an array
is intended for mathematical use.  If \code{x} were a Numpy array, the code would be as simple as:
\begin{Verbatim}
